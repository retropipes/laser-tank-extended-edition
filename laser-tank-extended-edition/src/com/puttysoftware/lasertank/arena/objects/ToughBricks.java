...
public class ToughBricks extends ArenaObject {
	...
	public Direction laserEnteredActionHook(final int locX, final int locY, final int locZ, final int dirX,
		...
		LaserTankEE.getGame().morph(new ArenaObject(GameObjectID.BRICKS), locX, locY, locZ, this.getLayer());
	...
	public boolean rangeActionHook(final int locX, final int locY, final int locZ, final int dirX, final int dirY,
		...
		Sounds.play(Sound.BREAK_BRICKS);
		LaserTankEE.getGame().morph(new ArenaObject(GameObjectID.BRICKS), locX + dirX, locY + dirY, locZ,
				this.getLayer());
		return true;
	}
}