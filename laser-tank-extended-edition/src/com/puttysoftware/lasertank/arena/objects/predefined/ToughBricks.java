...
public class ToughBricks extends ArenaObject {
	...
	Game.get().morph(new ArenaObject(GameObjectID.BRICKS), locX, locY, locZ, this.getLayer());
	...
	Sounds.play(Sound.BREAK_BRICKS);
	Game.get().morph(new ArenaObject(GameObjectID.BRICKS), locX + dirX, locY + dirY, locZ, this.getLayer());
	return true;
    }
}