...
public class ToughBricks extends ArenaObject {
	...
	Game.morph(new ArenaObject(GameObjectID.BRICKS), locX, locY, locZ, this.layer());
	...
	Game.morph(new ArenaObject(GameObjectID.BRICKS), locX + dirX, locY + dirY, locZ, this.layer());
	return true;
    }
}