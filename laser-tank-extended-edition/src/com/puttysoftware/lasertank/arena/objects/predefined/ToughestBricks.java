...
public class ToughestBricks extends ArenaObject {
	...
	Game.get().morph(new ArenaObject(GameObjectID.TOUGHER_BRICKS), locX, locY, locZ, this.getLayer());
	...
	Sounds.play(Sound.BREAK_BRICKS);
	Game.get().morph(new ArenaObject(GameObjectID.TOUGHER_BRICKS), locX + dirX, locY + dirY, locZ, this.getLayer());
	return true;
    }
}