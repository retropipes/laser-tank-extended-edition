...
import com.puttysoftware.lasertank.engine.internal.DefaultAssets;
...
public final class MainWindow {
    ...
    private LTEMusicIndex currentMusic;
    ...
    private final LinkedList<LTEMusicIndex> savedMusicStack;
	...
	if (this.savedDepth > 0) {
		...
		try {
		    LTEMusicPlayer.play(this.currentMusic);
